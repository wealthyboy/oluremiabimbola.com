            ...
            <div v-if="showForm"  id="stored_address"  class="billing-fields__field-wrapper ">
                <form  @submit.prevent="submit" method="POST" class=""> 
                    <div class="row reduce-gutters" id="add-new-address-form" data-action="/address/create">
                        <p class="form-field-wrapper reduce-gutters col-lg-6">
                            <label for="first_name">First Name</label>
                            <input  :class="{'has-danger': errors.first_name}"  id="firstname" 
                            v-model="form.first_name" 
                            @input="removeError($event)"  
                            @blur="vInput($event)" 
                            type="text" class="input--lg form-full required" 
                            name="first_name"
                            >
                        ...
                        <p class="form-field-wrapper reduce-gutters col-lg-6">
                            ...
                            <input id="lastname"
                                ...
                                @input="removeError($event)"  
                                @blur="vInput($event)"  
                                class="input--lg form-full required"
                                name="last_name" 
                            >
                        ...
                        <p class="form-field-wrapper reduce-gutters col-md-12">
                        ...
                        <p class="form-field-wrapper reduce-gutters col-lg-12">
                            <label for="address_2">Address 2</label>
                            <input id="address_2"  v-model="form.address_2"  type="text" class="input--lg form-full" name="address_2"  autofocus autocomplete="off">
                        </p>
                        <p class="form-field-wrapper  reduce-gutters col-lg-6">
                        ...
                        <p class="form-field-wrapper  reduce-gutters col-lg-6">
                            ...
                            <input id="postal_code" 
                                ...
                                type="text" class="input--lg form-full"
                                name="postal_code"
                            >
                        </p>
                        <p class="form-field-wrapper reduce-gutters  col-sm-6">
                            <label for="shipping_country">Country &nbsp;<abbr class="required" title="required">*</abbr></label>
                            <select @change="getState"  v-model="form.country_id"  name="country_id" id="shipping_country"   class="form-full input--lg required" autocomplete="country" tabindex="-1" aria-hidden="true">
                        ...
                        <p class="form-field-wrapper reduce-gutters col-sm-6">
                            ...
                            <select @change="getShipping"  v-model="form.state_id"  name="state_id" id="state_id" class="form-full input--lg required">
                        ...
                        <p class="form-field-wrapper reduce-gutters col-lg-12">
                            ...
                            <p v-if="addresses.length" class="form-field-wrapper col-6 col-md-6">
                                <button type="submit" class="btn btn--lg btn--white bold color--primary"  value="Submit">
                                    <span  v-if="submiting" class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                    Save 
                                </button>
                            </p>
                            <p v-if="addresses.length" class="form-field-wrapper col-6  col-md-6 lost_password">
