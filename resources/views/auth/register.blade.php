                        ...
                        <form method="POST" action="/register">
                            ...
                            <div class="row  no-gutters ">
                                ...
                                <p class="form-field-wrapper p-1 col-6">
                                    ...
                                    <input id="phone_number" type="text" class="input--lg form-full" name="phone_number" value="{{ old('phone_number') }}" required autofocus>
                                </p>
                                <div class="clearfix"></div>
                                ...
                                <p class="form-field-wrapper p-1 col-6">
                                    ...
                                    <input id="password" type="password" class="input--lg form-full" name="password_confirmation" required>
                                </p>
                                <div class="clearfix"></div>
                            ...
                            <p class="text-center"> By registering your details, you agree with our <a class="color--primary bold" href="https://ohram.org/pages/terms-conditions">Terms & Conditions</a> , and <a class="color--primary bold" href="https://ohram.org/pages/privacy-policy">Privacy and Cookie Policy.</a> </p>
