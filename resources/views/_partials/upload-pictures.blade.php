                    ...
                    <div class=" mt-4 mb-4">
                        <form method="POST"  class="form-validate" id="" enctype="multipart/form-data" action="{{ route('picture.store') }}">
                            ...
                            <div class="text-center">
                                <h3>Upload Mrs Abimbola's Pictures</h3>
                                <p class=""> </p>
                            ...
                            <div class="row  no-gutters ">
                                ...
                                <p class="form-field-wrapper p-1 col-12">
                                    ...
                                    <input  type="hidden" value="{{ 'pictures' }}" class="input--lg form-full" name="type"   autofocus>
                                    <input  type="hidden" value="picture" class="input--lg form-full" name="post"   autofocus>
                                ...
                                <p class="form-field-wrapper p-1 col-12">
                                    ...
                                    <textarea id="Comment" class="input--lg form-full"  placeholder="Title/place and date" name="comments"></textarea>
                                </p>
                                <div class="clearfix"></div>

                                <p class="form-field-wrapper col-6">
                                    <button type="submit"  id="submit" class="btn btn--lg btn--primary ml-1 bold" name="register" value="Log in">Submit</button>
                                </p>
