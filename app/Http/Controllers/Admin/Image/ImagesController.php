    ...
    public function uploadImage(Request $request)
    {
        ...
        if($request->hasFile('file')){
          ...
          //  $path =  public_path('images/'. $request->folder );
            ...
            //     Storage::makeDirectory(public_path('images/'. $request->folder ));
            //     Storage::makeDirectory(public_path('images/'. $request->folder.'/m' ));
            //     Storage::makeDirectory(public_path('images/'. $request->folder.'/tn' ));
            // }
